...
-- CreateIndex
CREATE INDEX "Model_replicateRequestId_idx" ON "Model"("replicateRequestId");

-- CreateIndex
CREATE INDEX "OutputImages_replicateRequestId_idx" ON "OutputImages"("replicateRequestId");
